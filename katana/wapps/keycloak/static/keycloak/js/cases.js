var cases = {
    ...
    displayadmindetails: function(){
        console.log("displaying admin details...")
        document.getElementById("adminresult").style.display = "block"
        // document.getElementById("adminresult").innerHTML="<h3>This is admin control panel...</h3>"
    },
    ...
    themechange: function(){
        ...
        if(value == "Green-Pink"){
            document.getElementsByClassName("colstyle")[0].style.backgroundColor="#329149";
            document.getElementsByClassName("result")[0].style.backgroundColor="#d53764";
            document.getElementsByClassName("colstyle")[1].style.backgroundColor="#329149";
            document.getElementsByClassName("result")[1].style.backgroundColor="#d53764";
        }
        else if(value == "Yellow-Red"){
            document.getElementsByClassName("colstyle")[0].style.backgroundColor="#ffdd26";
            document.getElementsByClassName("result")[0].style.backgroundColor="#9b3131";
            document.getElementsByClassName("colstyle")[1].style.backgroundColor="#ffdd26";
            document.getElementsByClassName("result")[1].style.backgroundColor="#9b3131";
        }
        else{
            document.getElementsByClassName("colstyle")[0].style.backgroundColor="#8bd4ff";
            document.getElementsByClassName("result")[0].style.backgroundColor="#329149";
            document.getElementsByClassName("colstyle")[1].style.backgroundColor="#8bd4ff";
            document.getElementsByClassName("result")[1].style.backgroundColor="#329149";
        }
    },
