...
urlpatterns = [
    ...
    url(r'openid/', include("keycloak_oidc.urls")),
    url(r'^$', RedirectView.as_view(url='/katana/')),
    url(r'^katana/container/', include('katana.wapps.container.urls')),
    url(r'^katana/assembler/', include('katana.wapps.assembler.urls')),
    url(r'^katana/suites/', include('katana.wapps.suites.urls')),
    url(r'^katana/keycloak/', include('katana.wapps.keycloak.urls')),
